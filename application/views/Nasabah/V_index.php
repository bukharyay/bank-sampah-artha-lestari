                        ...
                        <div class="card-body d-flex flex-column">
                          ...
                          <div class="progress progress-md w-100 my-2">
                            <div class="progress-bar bg-success"
                                 style="width: <?= ( ( $setor_sampah->total_sampah ?? 0 ) > 0 ) ? round ( ( $setor_sampah->sampah_disetor / $setor_sampah->total_sampah ) * 100 ) : 0 ?>%"
                                 role="progressbar" aria-valuenow="<?= $setor_sampah->sampah_disetor ?? 0 ?>"
                                 aria-valuemin="0" aria-valuemax="<?= $setor_sampah->total_sampah ?? 0 ?>">
                            </div>
                          </div>
                  ...
                  if ($("#data_grafik_history_transaksi").length) {
                    ...
                    var salesTopData = {
                      ...
                      datasets: [{
                        ...
                        pointBorderWidth: 1,
                        pointRadius: 4,
                        pointHoverRadius: 6, // Increased for better hover visibility
                              ...
                              <?php foreach ( $locations as $index => $lc ) : ?>
                                <li>
                                  <div class="d-flex justify-content-between">
                                    ...
                                    <p><a href="https://www.google.com/maps/place/<?= $lc[ 'Lat' ] . ',' . $lc[ 'Lon' ] ?>"
                                         target="_blank" rel="noopener noreferrer">Check Maps</a></p>
                                  </div>
                                </li>
                              <?php endforeach; ?>
                            <?php endif; ?>
