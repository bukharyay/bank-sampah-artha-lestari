																	...
																	<div class="shadow-sm rounded-3 hover-effect h-100">
																		<div class="card h-100 rounded shadow-sm border-0 overflow-hidden ">
																			...
																			<div class="position-relative overflow-hidden" style="height: 250px; ">
																				<img class="card-img-top w-100 h-100 object-fit-cover" src="<?= base_url('assets/uploads/karya/') . htmlspecialchars($hkt->gambar) ?>" alt="<?= htmlspecialchars($hkt->gambar_alt ?? $hkt->judul) ?>" loading="lazy">
																			...
																			<div class="card-body d-flex flex-column p-3">
																				...
																				<div class="d-flex justify-content-between align-items-center border-top pt-3 ">
																					<a href="<?= base_url('artikel/') . url_title($hkt->slug ?? '') ?>" class="btn border-0 btn-link text-primary text-decoration-none p-0 m-0">
																						Baca Selengkapnya
																						<i class="mdi mdi-arrow-right ms-1 align-middle"></i>
																					</a>
																					<div class=" small">
																						<i class="mdi mdi-eye me-1 align-middle"></i><?= number_format($hkt->read_count) ?>
																					</div>
																				</div>
																			</div>
																		</div>
									...
									<div class="card card-rounded">
										<div class="card-body">
											<div class="d-flex justify-content-between align-items-center mb-3">
												...
												<a href="<?= base_url('Laporan-Transaksi?status=dibawa') ?>" class="btn btn-sm btn-primary text-white">Lihat Semua</a>
											</div>
