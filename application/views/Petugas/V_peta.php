...
<div class="main-panel">
  <div class="content-wrapper">
                  ...
                  <div class="row justify-content-center w-auto mx-auto">
                    <div class="col-12 col-sm-12 col-md-10 col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text"
                               class="form-control  <?= form_error ( 'nama_lokasi	' ) ? 'is-invalid' : ''; ?>"
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error ( 'latitude	' ) ? 'is-invalid' : ''; ?>"
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error ( 'longitude	' ) ? 'is-invalid' : ''; ?>"
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control <?= form_error ( 'alamat	' ) ? 'is-invalid' : ''; ?>"
                                  style="height: 6em;" name="alamat" required></textarea>
                        <div class="invalid-feedback">
                          <?= form_error ( 'alamat' ); ?>
                        </div>
                      </div>
                      <div class="mt-3 d-flex justify-content-end">
                        <button type="submit" class="btn btn-success fw-bolder fs-6 my-2 ">Tambah <i
                             class="icon-pencil m-0 p-1 fw-bolder fs-6 align-middle"></i></button>
                      </div>
                    </div>
                  </div>
                </form>
    ...
    <div class="card mb-4">
      <!-- Changed mb-3 to mb-4 for better spacing -->
      <div class="card-body p-4">
        <!-- Added padding -->
        <h4 class="card-title text-center mb-4">Daftar Lokasi</h4> <!-- Added margin-bottom -->
        <div class="table-responsive">
          <table id="daftar_lokasi" class="table table-striped table-hover table-bordered nowrap" style="width:100%">
            <thead class="table-light">
              <!-- Added light header background -->
              <tr>
                ...
                <th class="text-center">Aksi</th> <!-- Changed "Action" to "Aksi" for consistency -->
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center align-middle">
                  <div class="btn-group " role="group">
                    ...
                    <button type="button" class="btn btn-sm btn-outline-warning  btn-update-lokasi"
                            data-toggle="tooltip" title="Edit" data-id-lokasi="<?= $loc[ 'id_lokasi' ] ?>"
                            data-nama-lokasi="<?= htmlspecialchars ( $loc[ 'Desc' ] ) ?>"
                            data-alamat="<?= htmlspecialchars ( $loc[ 'alamat' ] ) ?>"
                            data-latitude="<?= htmlspecialchars ( $loc[ 'Lat' ] ) ?>"
                            data-longitude="<?= htmlspecialchars ( $loc[ 'Lon' ] ) ?>"
                            data-action="<?= base_url ( 'Edit-Peta/' . $loc[ 'id_lokasi' ] ) ?>">
                      <i class="mdi mdi-pencil align-middle"></i>
                    </button>
                    <button type="button" class="btn btn-sm btn-outline-danger btn-delete-lokasi" data-toggle="tooltip"
                            title="Hapus" data-id-lokasi="<?= $loc[ 'id_lokasi' ] ?>"
                            data-nama-lokasi="<?= htmlspecialchars ( $loc[ 'Desc' ] ) ?>"
                            data-alamat="<?= htmlspecialchars ( $loc[ 'alamat' ] ) ?>"
                            data-latitude="<?= htmlspecialchars ( $loc[ 'Lat' ] ) ?>"
                            data-longitude="<?= htmlspecialchars ( $loc[ 'Lon' ] ) ?>"
                            data-action="<?= base_url ( 'Delete-Peta/' . $loc[ 'id_lokasi' ] ) ?>">
  ...
  <div class="modal fade" id="lokasiEditModal" tabindex="-1" aria-labelledby="lokasiEditModalLabel"
       style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title text-warning" id="lokasiEditModalLabel">Edit Lokasi <i
        ...
        <div class="modal-body">
          <form id="formEditLokasi" method="POST">
            ...
            <div class="form-group">
              <label for="nama_lokasi">Nama Lokasi:</label>
              <input type="text" class="form-control  <?= form_error ( 'nama_lokasi	' ) ? 'is-invalid' : ''; ?>"
                     name="nama_lokasi" id="nama_lokasi_edit" required>
              <div class="invalid-feedback">
                <?= form_error ( 'nama_lokasi' ); ?>
              </div>
            </div>
            ...
            <div class="form-group">
              <label for="alamat">Alamat:</label>
              <textarea class="form-control <?= form_error ( 'alamat	' ) ? 'is-invalid' : ''; ?>" style="height: 6em;"
                        name="alamat" id="alamat_edit" required></textarea>
              <div class="invalid-feedback">
                <?= form_error ( 'alamat' ); ?>
              </div>
            </div>
  ...
  <div class="modal fade" id="lokasiHapusModal" tabindex="-1" aria-labelledby="lokasiHapusModalLabel"
       style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title text-danger" id="lokasiHapusModalLabel">Hapus lokasi <i
