								...
								<div class="col-12 col-sm-12 col-md-10 col-lg-6">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="text" class="form-control form-control-lg border-left-0  <?= form_error('username') ? 'is-invalid' : ''; ?>" id="username" name="username" value="<?= set_value('username') ?>" placeholder="Username" required>
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="email" class="form-control form-control-lg border-left-0 <?= form_error('email') ? 'is-invalid' : ''; ?>" id="email" name="email" value="<?= set_value('email') ?>" placeholder="Email">
											<div class="invalid-feedback">
												<?= form_error('email'); ?>
											</div>
										</div>
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="password" class="form-control form-control-lg border-left-0  <?= form_error('password_confirmation') ? 'is-invalid' : ''; ?>" id="password_confirmation" name="password_confirmation" placeholder="Konfirmasi Password" required>
											<div class="invalid-feedback">
								...
								<div class="col-12 col-sm-12 col-md-10 col-lg-6">
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="text" class="form-control form-control-lg border-left-0  <?= form_error('nama') ? 'is-invalid' : ''; ?>" id="nama" name="nama" value="<?= set_value('nama') ?>" placeholder="Nama Lengkap" required>
											<div class="invalid-feedback">
												<?= form_error('nama'); ?>
											</div>
										</div>
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="number" class="form-control form-control-lg border-left-0  <?= form_error('no_telfon') ? 'is-invalid' : ''; ?>" id="no_telfon" name="no_telfon" value="<?= set_value('no_telfon') ?>" placeholder="No Telfon">
											<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<textarea class="form-control form-control-lg border-left-0  <?= form_error('alamat') ? 'is-invalid' : ''; ?>" name="alamat" id="alamat" cols="30" rows="10" placeholder="Alamat Tinggal"><?= set_value('alamat') ?></textarea>
											<div class="invalid-feedback">
												<?= form_error('alamat'); ?>
											</div>
										</div>
