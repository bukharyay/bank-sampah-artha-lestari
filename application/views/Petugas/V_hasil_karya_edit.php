					...
					<div class="row">
						<div class="col-md-8">
							<div class="form-group mb-4">
								...
								<input type="text" name="judul" class="form-control form-control-lg" placeholder="Masukkan judul karya" value="<?= htmlspecialchars($karya->judul) ?>" required>
									...
									<div class="form-group mb-4">
										...
										<select name="id_jenis_sampah" id="id_jenis_sampah" class="form-control" required>
											...
											<?php foreach ($jenis_sampah as $js) : ?>
												<option value="<?= $js->id_jenis_sampah ?>" <?= ($js->id_jenis_sampah == $karya->id_jenis_sampah) ? 'selected' : '' ?>>
													<?= $js->jenis_sampah ?>
												</option>
											<?php endforeach; ?>
										</select>
									...
									<div class="form-group mb-4">
										...
										<div class="mt-2" id="currentImagePreview">
											<div class="border p-2 rounded">
												<img src="<?= base_url('./assets/uploads/karya/' . $karya->gambar) ?>" class="img-fluid rounded" style="max-height: 200px;">
