					...
					<div class="card-body">
						...
						<div class="container-fluid d-flex justify-content-between">
							<div class="col-6 ps-0">
								...
								<p>Jl. Meranti Tim. Dlm IV No.17, <br> Padangsari, Kec. Banyumanik, <br> Kota Semarang, Jawa Tengah
									50263</p>
							</div>
						...
						<div class="container-fluid w-100">
							<form method="post" id="form_checkout">
								<a href="<?= base_url('Manage-Transaksi') ?>" class="btn btn-secondary fw-bolder fs-6 my-2"><i class=" icon-action-undo m-0 p-1 fw-bolder fs-6"></i>Back</a>
								<a href="<?= base_url('Checkout-Print/') . $kode_transaksi ?>" target="_blank" class="btn btn-dark fw-bolder fs-6 my-2"><i class="icon-printer m-0 p-1 fw-bolder fs-6"></i>Print</a>
								<input type="hidden" id="kode_transaksi" name="kode_transaksi" value="<?= $kode_transaksi ?>">
								<button type="submit" class="btn btn-success fw-bolder fs-6 my-2"><i class="icon-basket-loaded m-0 p-1 fw-bolder fs-6"></i>Checkout</button>
							</form>
						</div>
					</div>
				</div>
