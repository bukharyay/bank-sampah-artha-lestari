                ...
                <tr>
                  ...
                  <td class="text-center">
                    <div class="img-thumbnail-container">
                      <img src="<?= base_url ( './assets/uploads/karya/' . $item->gambar ) ?>" alt="<?= $item->judul ?>"
                           class="img-thumbnail img-fluid" data-toggle="modal"
                           data-target="#imageModal-<?= $item->id_hasil_karya ?>">
                    </div>

                    <!-- Image Preview Modal -->
                    <div class="modal fade" id="imageModal-<?= $item->id_hasil_karya ?>" tabindex="-1" role="dialog"
                         aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content bg-transparent border-0">
                          <div class="modal-body text-center p-1">
                            <img src="<?= base_url ( './assets/uploads/karya/' . $item->gambar ) ?>"
                                 class="img-fluid img-thumbnail w-50 h-auto">
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <td>
                    <div class="text-truncate" style="max-width: 250px;" data-toggle="tooltip"
                         title="<?= htmlspecialchars ( strip_tags ( $item->konten ) ) ?>">
                  ...
                  <td class="text-center">
                    <div class="btn-group" role="group">
                      <a href="<?= base_url ( 'Hasil-Karya/edit/' . $item->id_hasil_karya ) ?>"
                         class="btn btn-sm btn-outline-warning" data-toggle="tooltip" title="Edit">
                        <i class="mdi mdi-pencil align-middle"></i>
                      </a>
                      <button type="button" class="btn btn-sm btn-outline-danger btn-delete-karya"
                              data-id="<?= $item->id_hasil_karya ?>" data-judul="<?= htmlspecialchars ( $item->judul ) ?>"
                              data-action="<?= base_url ( 'Hasil-Karya/delete/' . $item->id_hasil_karya ) ?>"
