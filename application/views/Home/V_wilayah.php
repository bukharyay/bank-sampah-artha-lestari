			...
			<div class="col-12 text-center pt-8">
				...
				<div class="card h-100 border-0 shadow-sm">
					<div class="card-body">
						...
						<p class="card-text">
							<i class="icon icon-sm mdi mdi-map-marker text-primary me-2"></i>
							Jl. Meranti Tim. Dlm IV No.17, Padangsari, Kec. Banyumanik, Kota Semarang, Jawa Tengah 50263
						</p>
						<p class="card-text">
							<i class="icon icon-sm mdi mdi-clock-outline text-primary me-2"></i> Senin-Jumat: 08.00-16.00
						</p>
						<p class="card-text">
							<i class="icon icon-sm mdi mdi-phone text-primary me-2"></i> +6282327575717
						</p>
					</div>
				</div>
			</div>
