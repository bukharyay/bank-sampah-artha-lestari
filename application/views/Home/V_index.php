  ...
  <div class="container position-relative">
    <div class="row align-items-center min-vh-75">
      <div class="col-md-5 col-lg-6 order-md-1 pt-8">
        <img class="img-fluid" src="<?= base_url () ?>assets/landing/img/illustrations/save-earth.png"
             alt="Bank Sampah Artha Lestari">
      </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6">
        <div class="card border-0 shadow-sm overflow-hidden">
          <div class="card-body p-0">
            <img src="<?= base_url () ?>assets/landing/img/illustrations/family-recycling-together.svg"
                 alt="Proses Pengolahan Sampah" class="img-fluid w-100">
            <div class="p-4">
    ...
    <div class="row justify-content-center">
      <div class="col-12 col-lg-10">
        <div class="carousel slide carousel-fade" id="testimonialCarousel" data-bs-ride="carousel">
                    ...
                    <div class="col-md-4 text-center mb-4 mb-md-0">
                      <div class="position-relative">
                        <img src="<?= base_url () ?>assets/landing/img/gallery/default.png"
                             class="rounded-circle border border-4 border-primary shadow-lg" width="160" alt="Nasabah">
                ...
                <div class="card-body p-5">
                  <div class="row align-items-center">
                    <div class="col-md-4 text-center mb-4 mb-md-0">
                      <div class="position-relative">
                        <img src="<?= base_url () ?>assets/landing/img/gallery/default.png"
                             class="rounded-circle border border-4 border-warning shadow-lg" width="160" alt="Nasabah">
          ...
          <div class="row mt-5">
            <div class="col-12 text-center">
              <button class="btn btn-icon btn-primary rounded-circle p-2 me-3" type="button"
              ...
              <button class="btn btn-icon btn-primary rounded-circle p-2 ms-3" type="button"
            ...
            <div class="row g-4">
              <div class="col-md-6">
                <div class="d-flex align-items-start">
                  ...
                  <div>
                    <h5 class="fw-bold mb-3">Syarat Pendaftaran</h5>
                    <ul class="list-unstyled">
              ...
              <div class="col-md-6">
                <div class="d-flex align-items-start">
                  ...
                  <div>
                    <h5 class="fw-bold mb-3">Dokumen Dibutuhkan</h5>
                    <ul class="list-unstyled">
            ...
            <div class="card-body d-flex flex-column pt-3">
              ...
              <div class="d-flex flex-wrap justify-content-between align-items-center  small mb-3">
                ...
                <div class="mb-1">
                  ...
                  <?= $CI->_format_waktu ( date ( 'd M Y', strtotime ( $a->tanggal_dibuat ) ), 'hari, bulan tahun' ) ?>
                </div>
              </div>
