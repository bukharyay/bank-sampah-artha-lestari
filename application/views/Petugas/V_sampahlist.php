...
<div class="main-panel">
  <div class="content-wrapper">
    ...
    <div class="modal fade" id="hargaUpdateModal" tabindex="-1" aria-labelledby="hargaUpdateModalLabel"
         style="display: none;" aria-hidden="true">
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title text-info" id="hargaUpdateModalLabel">Update Harga Sampah <i
            ...
            <form id="formUpdateHarga" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="harga_per_kg" name="harga_per_kg"
                       placeholder="Harga Sampah" required>
              ...
              <div class="form-group">
                ...
                <input type="date" class="form-control" id="periode" name="periode"
                       min="<?= date ( 'Y-m-d', strtotime ( '-1 week' ) ) ?>" max="<?= date ( 'Y-m-d' ) ?>" required>
              </div>
    ...
    <div class="modal fade" id="sampahEditModal" tabindex="-1" aria-labelledby="sampahEditModalLabel"
         style="display: none;" aria-hidden="true">
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title text-warning" id="sampahEditModalLabel">Edit Sampah <i
          ...
          <div class="modal-body">
            <form id="formEditSampah" method="POST">
              ...
              <div class="form-group <?= form_error ( 'nama_sampah' ) ? 'has-danger' : '' ?>">
                ...
                <input type="text" class="form-control" id="nama_sampah_edit" name="nama_sampah" placeholder="Sampah"
                       required>
    ...
    <div class="modal fade" id="sampahHapusModal" tabindex="-1" aria-labelledby="sampahHapusModalLabel"
         style="display: none;" aria-hidden="true">
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title text-danger" id="sampahHapusModalLabel">Hapus Sampah <i
