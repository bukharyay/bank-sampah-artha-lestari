...
class C_Admin extends MY_Controller
	...
	public function index ()
		...
		$data = [ 
			...
			'perbedaan_transaksi'           => $chart_data[ 'data_jumlah_transaksi' ][ 0 ] - $chart_data[ 'data_nilai_transaksi_bulanan' ][ 0 ],
			'persentase_perubahan'          => $this->_calculate_percentage_change (
				$chart_data[ 'data_jumlah_transaksi' ][ 0 ],
				$chart_data[ 'data_jumlah_transaksi_bulanan' ][ 0 ],
			),
		];
